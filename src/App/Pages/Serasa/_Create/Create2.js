...
import {generateBusinessReport, generateReport} from "../../test/service";
// import Radio from "../../components/Form/Radio";
// import Results from "../../Containers/Searches/Result/Results";
    ...
    return (
        <FormProvider {...methods}>
            ...
            {isResultView2Visible && (
                <>
                    <button onClick={handleBaixarPDF}>Baixar Relatório PDF</button><br></br><br></br><br></br>
                    <Row className="w-100">
                        <Col className="w-100">
                    ...
                    <br></br>
                    <button onClick={handleConsultarSocios}>Consultar Sócios</button><br></br><br></br>
                </>
            )}
        </FormProvider>
    );
