...
import NavProvider from "../../../../components/Sidebar/NavProvider/NavProvider";
...
const OffcanvasSidebar = ({openned=false}) => {
  return (
    <>
      ...
      {show && (
        <Offcanvas className={
          "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"} show={show} onHide={() => setShow(false)}>
