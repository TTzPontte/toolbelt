...
import NavProvider from "../Sidebar/NavProvider/NavProvider";
...
const TopNavbar = ({currentUser}) => {
  ...
  <>
    ...
    <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style={{zIndex: 1}}>
      <Col>
        <NavProvider>
          {({ toogleShowNav }) => (
            <button
