...
export default function PredictusReportCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PredictusReport(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PredictusReportCreateForm")}
      {...rest}
    >
      <TextField
